<template>
   <section class="container">
      ...
      <div class="sub_content">
         ...
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.number}}
            </div>
         </div>
      </div>
      <div class="sub_content">
      ...
      <div class="sub_content">
         ...
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.content}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">优惠类型</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.disType?bizDataInfo.disType.alias:""}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">优惠活动依据</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.discount?bizDataInfo.discount.preferentialContent:""}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">增加选校数</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.addSelects}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">给予内容</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.gift}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">优惠价值金额</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.discountAmontJZ}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">优惠金额</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.discountAmont}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">优惠活动编号</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.discount?bizDataInfo.discount.preferentialNo:""}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">优惠活动条件</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.useFilters}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">标准优惠金额</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.standardAmount}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">额外选校数</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.extraSelect}}
            </div>
         </div>
      </div>
      <!---------------------------------------------------------------------------------------------------------------->
      <div class="sub_title">
         <div class="sub_title_content">合同内容</div>
      </div>
      ...
      <div class="sub_content">
         ...
         <!--<div class="sub_content_info">{{bizDataInfo.productType?(bizDataInfo.productType.name?bizDataInfo.productType.name.l2:""):""}}</div>-->
         <div class="sub_content_info">
      ...
      <div class="sub_content">
         ...
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.country}}
            </div>
         </div>
      </div>
      <div class="sub_content">
