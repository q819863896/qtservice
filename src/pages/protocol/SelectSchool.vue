<template>
   <section class="container">
      ...
      <div class="sub_content">
         ...
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.number}}111111111111111111111111111111111111111111
            </div>
         </div>
      </div>
      <div class="sub_content">
      ...
      <div class="sub_content">
         <div class="sub_content_title">国家</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.country?bizDataInfo.country.name.l2:""}}
            </div>
         </div>
      </div>
      <div class="sub_content">
      ...
      <div class="sub_content">
         <div class="sub_content_title">院校排名</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.schoolRank==="true"?"是":"否"}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">控制方式</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.controlType?bizDataInfo.controlType.alias:""}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">基准选校数</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.baseQty}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">选择院校数</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.currentQty}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">变更申请选校数</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.changedQty}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">应收选校费</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.addamount}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">实收选校费</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.actualAmount}}
            </div>
         </div>
      </div>
      <div class="sub_content">
      ...
      <el-table class="school_info" :data="bizDataInfo.entry" border style="width: 100%" size="mini" :header-cell-style="{background:'#51C4D4',textAlign:'center',padding:0}">
         <el-table-column label="学校中文名" prop="school.name.l2" min-width="50px"></el-table-column>
         <el-table-column label="学校英文名" prop="schoolEn" min-width="50px"></el-table-column>
         <el-table-column label="专业中文名" prop="specialtyDetailC" min-width="50px"></el-table-column>
         <el-table-column label="专业英文名" prop="specialtyDetailE" min-width="50px"></el-table-column>
         <el-table-column label="取消申请" prop="isCancel" min-width="50px"></el-table-column>
      </el-table>

      <div class="discount">
         <div class="discount_title">特殊需求</div>
         <el-input class="discount_area" type="textarea" :rows="3" readonly v-model="bizDataInfo.comment"></el-input>
      </div>
      <!---------------------------------------------------------------------------------------------------------------->
