<template>
   <section class="container">
      ...
      <div class="sub_content">
         ...
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.number}}11111111111111111111111111111111111
            </div>
         </div>
      </div>
      <div class="sub_content">
      ...
      <div class="sub_content">
         <div class="sub_content_title">标准服务金额</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.changeAccountBZ}}
            </div>
         </div>
      </div>
      <div class="sub_content">
         <div class="sub_content_title">增加服务金额</div>
         <div class="sub_content_info">
            <div class="sub_content_info_txt"> {{bizDataInfo.changeAccount}}
            </div>
         </div>
      </div>
      <div class="sub_content">
      ...
      <el-table class="school_info" :data="bizDataInfo.entry" border style="width: 100%" size="mini" :header-cell-style="{background:'#51C4D4',textAlign:'center',padding:0}">
         <el-table-column label="补充条款" prop="article.name.l2" min-width="50px"></el-table-column>
         <el-table-column label="条款内容" prop="articleConten" min-width="50px"></el-table-column>
         <el-table-column label="标准服务费单价" prop="standardPrices" min-width="50px"></el-table-column>
         <el-table-column label="标准服务费数量" prop="numOfPrice" min-width="50px"></el-table-column>
         <el-table-column label="标准服务费金额" prop="serverAmountBZ" min-width="50px"></el-table-column>
      </el-table>

      <!-- <div class="require_info">
             <span>协议说明</span>
             <el-input class="require_info_area" type="textarea" :rows="3" v-model="discountForm.checkSuggest"></el-input>
          </div>-->
      <div class="discount">
         <div class="discount_title">协议说明</div>
         <el-input class="discount_area" type="textarea" :rows="3" readonly v-model="bizDataInfo.content"></el-input>
      </div>
      <!---------------------------------------------------------------------------------------------------------------->
      ...
      <el-collapse v-model="activeName" class="discount_collapse">
         <el-collapse-item name="1" title="查看审批意见">
            <div class="suggest_infos" v-for="(item ,index) in multiAppList" :key="index" v-if="multiAppList.length">
               ...
               <div class="suggest_infos_message">审批意见: <p>{{item.auditAdvice}}</p>
               </div>
            </div>
